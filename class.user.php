...
class USER
{
    ...
    function send_mail($email,$message,$subject)  //all the mail settings for verification emails
    {
        ...
        $mail->Username="real-email-address@gmail.com";
        $mail->Password="password-to-real-email-address";
        $mail->SetFrom('real-email-address@gmail.com','Website Name');
        $mail->AddReplyTo("Another-different-email-address","Website Name");
