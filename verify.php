 ...
 * Time: 9:48 AM
 *
 * FILE TITLE: VERIFY.PHP
 * PURPOSE OF THIS FILE: After registration a user will get an email with a link to activate and verify his/her account.
 * The link redirects to this file. The link also sends the id# and the code# for the user for processing here.
 * 
 */
